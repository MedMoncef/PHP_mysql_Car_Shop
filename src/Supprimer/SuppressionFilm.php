...
<?php
      ...
      ?>
    <center>
    <legend align="center">Supprimer Reussite</legend>
    <fieldset>
    <table border=2>
    <tr>
   ...
   $coun = 1;
    ...
    if ($i["IdV"] != $idvoiture) {
        ...
        <tr>
        <del>
        <td bgcolor= "#FFCCCB"> <?php echo ("<strong><del>$i[IdV]</del></strong>"); ?> </td>
        <td bgcolor= "#FFCCCB"> <?php echo ("<strong><del>$i[Voitures]</del></strong>"); ?> </td>
        <td bgcolor= "#FFCCCB"> <?php echo ("<strong><del>$i[Prix]</del></strong>"); ?> </td>
        <td bgcolor= "#FFCCCB"> <?php echo ("<strong><del>$i[Description]</del></strong>"); ?> </td>
        </del>
        </tr>
